...
class GroupTipsMessageCell: UITableViewCell {
...
extension GroupTipsMessageCell {
    ...
    func configure(_ citem: LIMMessage) {
        ...
        // 消息内容
        messageLabel.text = LIMModel.GetGroupTipsContent(item.groupTipsElem)
